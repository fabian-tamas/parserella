...
def scrape():
    ...
    headers = {'User-Agent': 'ParserellaScrape/1.0'}
...
def edgardaily():
    ...
    try:
        ...
        headers = {'User-Agent':'Ion Analytics tamas.fabian@iongroup.com','Accept-Encoding':'gzip, deflate','Host':'www.sec.gov'}

        url = str(base_url) + str(yearUrl) + "/" + str(QTR) + "/" + "crawler." + fileDate + ".idx"
        archive = requests.get(url, headers = headers, timeout=10)
        lines = archive.text.split("\n")
...
def edgarquarterly():
    ...
    url = str(base_url) + str(fileDate) + "/" + str(fileQTR) + "/" + "crawler.idx"
    archive = requests.get(url, headers = headers, timeout=10)
    print(archive)
    lines = archive.text.split("\n")
    ...
    if dailyfilings == []:
        row = ("No filling for " + fileType + " for this quarter: " + str(fileQTR) + "," + "" + "," + "" + "," + "" + "," + "" + "," + "").split(",")
        dailyfilings.append(row)
...
def results():
    ...
    if correct_url:
        ...
        truepage = False #will turn it to True if the status_code is 200

        while truepage == False:
...
def currency():
    ...
    try:    
        base_url = "https://www.xe.com/currencytables/?from=USD&date="
        exurl = base_url + str(date) + "#table-section"

        print(exurl)
        
        headers = {'User-Agent': 'kurrenszi/1.0'}
        expage = requests.get(exurl, headers = headers)
        exsoup = soup(expage.content, "html.parser")
        extable = exsoup.find("tbody")

        eurName = extable.find("th",string="EUR").a.text
        gbpName = extable.find("th",string="GBP").a.text
        brlName = extable.find("th",string="BRL").a.text
        chfName = extable.find("th",string="CHF").a.text
        jpyName = extable.find("th",string="JPY").a.text
        dkkName = extable.find("th",string="DKK").a.text
        nokName = extable.find("th",string="NOK").a.text
        sekName = extable.find("th",string="SEK").a.text
        audName = extable.find("th",string="AUD").a.text
        cadName = extable.find("th",string="CAD").a.text
        hkdName = extable.find("th",string="HKD").a.text
        zarName = extable.find("th",string="ZAR").a.text
        clpName = extable.find("th",string="CLP").a.text
        inrName = extable.find("th",string="INR").a.text
        lacName = "LAC"
        croName = "CRO"
        myrName = extable.find("th",string="MYR").a.text
        sgdName = extable.find("th",string="SGD").a.text
        nzdName = extable.find("th",string="NZD").a.text
        phpName = extable.find("th",string="PHP").a.text
        idrName = extable.find("th",string="IDR").a.text
        plnName = extable.find("th",string="PLN").a.text
        arsName = extable.find("th",string="ARS").a.text
        mxnName = extable.find("th",string="MXN").a.text
        ronName = extable.find("th",string="RON").a.text
        czkName = extable.find("th",string="CZK").a.text
        thbName = extable.find("th",string="THB").a.text
        hufName = extable.find("th",string="HUF").a.text
        rubName = extable.find("th",string="RUB").a.text
        usdName = "USD"



        eurValue = extable.find("th",string="EUR").parent.findAll("td")[2].text
        gbpValue = extable.find("th",string="GBP").parent.findAll("td")[2].text
        brlValue = extable.find("th",string="BRL").parent.findAll("td")[2].text
        chfValue = extable.find("th",string="CHF").parent.findAll("td")[2].text
        jpyValue = extable.find("th",string="JPY").parent.findAll("td")[2].text
        dkkValue = extable.find("th",string="DKK").parent.findAll("td")[2].text
        nokValue = extable.find("th",string="NOK").parent.findAll("td")[2].text
        sekValue = extable.find("th",string="SEK").parent.findAll("td")[2].text
        audValue = extable.find("th",string="AUD").parent.findAll("td")[2].text
        cadValue = extable.find("th",string="CAD").parent.findAll("td")[2].text
        hkdValue = extable.find("th",string="HKD").parent.findAll("td")[2].text
        zarValue = extable.find("th",string="ZAR").parent.findAll("td")[2].text
        clpValue = extable.find("th",string="CLP").parent.findAll("td")[2].text
        inrValue = extable.find("th",string="INR").parent.findAll("td")[2].text
        lacValue = float(inrValue)*100000
        croValue = float(inrValue)*10000000
        myrValue = extable.find("th",string="MYR").parent.findAll("td")[2].text
        sgdValue = extable.find("th",string="SGD").parent.findAll("td")[2].text
        nzdValue = extable.find("th",string="NZD").parent.findAll("td")[2].text
        phpValue = extable.find("th",string="PHP").parent.findAll("td")[2].text
        idrValue = extable.find("th",string="IDR").parent.findAll("td")[2].text
        plnValue = extable.find("th",string="PLN").parent.findAll("td")[2].text
        arsValue = extable.find("th",string="ARS").parent.findAll("td")[2].text
        mxnValue = extable.find("th",string="MXN").parent.findAll("td")[2].text
        ronValue = extable.find("th",string="RON").parent.findAll("td")[2].text
        czkValue = extable.find("th",string="CZK").parent.findAll("td")[2].text
        thbValue = extable.find("th",string="THB").parent.findAll("td")[2].text
        hufValue = extable.find("th",string="HUF").parent.findAll("td")[2].text
        rubValue = extable.find("th",string="RUB").parent.findAll("td")[2].text
